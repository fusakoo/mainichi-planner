    ...
    return (
      <form onSubmit={this.props.submitTheme}>
        ...
        <div className='radio-button'>
          <input type='radio' name='theme' id='light' value='light' defaultChecked onChange={this.props.updateSelectedTheme}></input>
          <label htmlFor='default'>Light (Default)</label>
        </div>
        <div className='radio-button'>
          <input type='radio' name='theme' id='dark' value='dark' onChange={this.props.updateSelectedTheme}></input>
          <label htmlFor='themeA'>Dark</label>            
        </div>
        <div className='radio-button'>
          <input type='radio' name='theme' id='seafoam' value='seafoam' onChange={this.props.updateSelectedTheme}></input>
